...
_obj1 = createVehicle ["Land_Cargo_House_V1_F", _objPS, [], 20, "none"]; 
...
_rNumber = random 4 ;
for "_i" from 0 to _rNumber do {
    _hilux = createVehicle ["UK3CB_ION_O_Woodland_M2_TriPod", _objPS, [], 20, "none"];
    _rNumber1 = random 360 ;
    _hilux setdir _rNumber1 ;
    _grp = createVehicleCrew _hilux;
    _hiluxPS = getPosATL _hilux;
    _hilux setpos [getPos _hilux select 0, getPos _hilux select 1, (getPos _hilux select 2) + 3 ];
};
