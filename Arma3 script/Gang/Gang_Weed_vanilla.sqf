...
_obj1 = createVehicle ["Land_FoodSacks_01_cargo_brown_F", _objPS, [], 1000, "none"]; 
_obj1PS = getPosATL _obj1;
_obj2 = createVehicle ["O_CagoNet_01_ammo_F", _obj1PS, [], 10, "none"]; 

OP_HQ_squad = [_obj1PS, east, (configfile >> "CfgGroups" >> "East" >> "OPF_G_F" >> "Infantry" >> "O_G_InfTeam_Light")] call BIS_fnc_spawnGroup;
...
for "_i" from 0 to _rNumber do {
    _hilux = createVehicle ["O_G_Offtoad_01_armed_F", _objPS, [], 300];
...
_rNumber = random 1 ;
for "_i" from 0 to _rNumber do {
    _ION_QRF = [_obj1PS, east, (configfile >> "CfgGroups" >> "East" >> "OPF_G_F" >> "Infantry" >> "O_G_InfSquad_Assault")] call BIS_fnc_spawnGroup;
...
for "_i" from 0 to _rNumber do {
    ...
    _SpecOps = [_objPS, east, (configfile >> "CfgGroups" >> "East" >> "OPF_G_F" >> "Infantry" >> "O_G_InfTeam_Light")] call BIS_fnc_spawnGroup;
