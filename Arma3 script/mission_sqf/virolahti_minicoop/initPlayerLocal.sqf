...
// eazyサブメニューを一括登録
{
    [player, 1, ["dynamic_mission_root", "easy_mission_root"], _x] call ace_interact_menu_fnc_addActionToObject;
} forEach [
    _spawnBaseAction,
    _spawnWaveAction,
];
...
// nomalサブメニューを一括登録
{
    [player, 1, ["dynamic_mission_root", "nomal_mission_root"], _x] call ace_interact_menu_fnc_addActionToObject;
} forEach [
    _spawnHardTownAction,
    _spawnCPAction,
    _cleanupCPAction
