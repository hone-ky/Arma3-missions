...
_obj = createVehicle ["O_supplyCrate_F", _landLocation, [], 100, "none"];  
_objPS = getPosATL _obj;
_obj1 = createVehicle ["CamoNet_BLUFOR_open_F", _objPS, [], 0, "none"];  
_obj1PS = getPosATL _obj1;

_MEI_HQ = [_objPS, east, (configfile >> "CfgGroups" >> "East" >> "rhsgref_faction_chdkz" >> "rhsgref_group_chdkz_insurgents_infantry" >> "rhsgref_group_chdkz_infantry_patrol")] call BIS_fnc_spawnGroup;
...
for "_i" from 0 to _rNumber do {
    _hilux = createVehicle ["rhsgref_ins_bmd1", _obj1PS, [], 300];
...
_rNumber = random 8 ;
for "_i" from 0 to _rNumber do {
    _MEI_sentry = [_objPS, east, (configfile >> "CfgGroups" >> "East" >> "rhsgref_faction_chdkz" >> "rhsgref_group_chdkz_insurgents_infantry" >> "rhsgref_group_chdkz_infantry_patrol")] call BIS_fnc_spawnGroup;
for "_i" from 1 to 4 do {
...
_rNumber = random 5 ;
for "_i" from 0 to _rNumber do {
    _MEI_QRF = [_objPS, east, (configfile >> "CfgGroups" >> "East" >> "rhsgref_faction_chdkz" >> "rhsgref_group_chdkz_insurgents_infantry" >> "rhsgref_group_chdkz_insurgents_squad")] call BIS_fnc_spawnGroup;
for "_i" from 1 to 4 do {
...
_ChDKZ_Town_RHS = createMarker ["ChDKZ_Town_RHS", _objPS];
"ChDKZ_Town_RHS" setMarkerType "hd_objective";
_trg = createTrigger ["EmptyDetector", _objPS, false];
_trg setTriggerArea [1000, 1000, -1, false];
_trg setTriggerActivation ["EAST", "NOT PRESENT", false];
_trg setTriggerStatements ["this", "deleteMarker 'ChDKZ_Town_RHS';", ""];
};