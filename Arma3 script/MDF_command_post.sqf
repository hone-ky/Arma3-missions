...
_centerobj = createVehicle ["Land_WaterBottle_01_cap_F",_trigger7, [], 5000, "none"];
...
for "_i" from 1 to _rNumber - 3 do {
    _hilux = createVehicle ["UK3CB_MDF_O_Warrior_Cage_Camo", _obj1PS, [], 100];
...
for "_i" from 0 to _rNumber do {
    _ION_QRF = [_obj1PS, east, (configfile >> "CfgGroups" >> "East" >> "UK3CB_MDF_O" >> "Infantry" >> "UK3CB_MDF_O_AT_Squad")] call BIS_fnc_spawnGroup;
...
for "_i" from 1 to _rNumber do {
    ...
    _SpecOps = [_objPS, east, (configfile >> "CfgGroups" >> "East" >> "UK3CB_MDF_O" >> "Infantry" >> "UK3CB_MDF_O_UGL_FireTeam")] call BIS_fnc_spawnGroup;
...
_marker = createMarker ["Marker13", _obj1ps];
"Marker13" setMarkerType "hd_objective";
_trg = createTrigger ["EmptyDetector", _obj1PS, false];
_trg setTriggerArea [1000, 1000, -1, false];
_trg setTriggerActivation ["EAST", "NOT PRESENT", false];
_trg setTriggerStatements ["this", "deleteMarker 'Marker13';", ""];